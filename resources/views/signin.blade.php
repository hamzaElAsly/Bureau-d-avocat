...
<head>
    <meta charset="utf-8">
    <title>Connexion | Cabinet d'avocat</title>
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="POST" action="{{ route('login.store') }}">
                            ...
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" id="floatingEmail" name="email" value="{{ old('email') }}" placeholder="nom@example.com" required autofocus>
                        ...
                        <p class="text-center mb-0">Je n'ai pas de compte ? <a href="{{ route('register') }}">Créer un compte</a></p>
                    </div>
                </div>
            </div>
        </div>
